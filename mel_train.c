...
mel_image_folder = '/Users/leechienju/Library/Mobile Documents/com~apple~CloudDocs/Documents/juice/juicemug2_mel_images/'
...
os.makedirs(mel_image_folder, exist_ok=True)
...
# Convert all audio files to WAV and generate MEL images
...
for label in label_mapping.keys():
    ...
    mel_label_path = os.path.join(mel_image_folder, label)
...
# Step 3: Extract Mel Spectrogram features for training
...
features = [extract_mel(wav_file) for wav_file in wav_files]
